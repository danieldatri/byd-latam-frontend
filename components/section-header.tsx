...
export const SectionHeader: React.FC<SectionHeaderProps> = ({ name, icon, link, linkLabel }) => (
  <div className="flex items-center justify-between mb-6 col-span-2 relative">
    ...
    <h2 className="font-playfair text-3xl font-bold flex items-center gap-2 relative z-10 text-gray-900">
    ...
    {link && (
      <a
        href={link}
        className="flex items-center gap-2 px-0 py-0 hover:bg-transparent hover:text-inherit focus:outline-none focus:ring-0 focus:border-0 text-gray-900"
